...
# 2618203
def general_regnetx_002(**kwargs):
...
if __name__ == '__main__':
    ...
    model = RegNet(Bottleneck, [2, 5, 15, 1], [80, 240, 720, 1920], group_width=120)

    import time
    t1 = time.time()
    res, m_l = model(a, b)
    t2 = time.time()
    print(t2 - t1)  # 0.1605710
