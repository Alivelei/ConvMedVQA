...
from framework.model.edgenext_mix.network.hidden_mix import BalancedTransMix, SoftTransMix, HardTransMix
...
class EdgeNeXt(nn.Module):
    def __init__(self, in_chans=3, depths=[3, 3, 9, 3], dims=[24, 48, 88, 168],
                 ...
                 use_pos_embd_global=False, d2_scales=[2, 3, 4, 5], qus_embedding_dim=300,
...
# 18056747 -> 18291599
def mix_hid_edgenext_base(**kwargs):
