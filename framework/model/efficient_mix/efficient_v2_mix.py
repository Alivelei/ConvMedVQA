...
class EfficientNetV2(nn.Module):
    ...
    def __init__(self,
        ...
        self.qus_emb = QusEmbeddingMap(glove_path, word_size, qus_embedding_dim, round_filters(self.cfg['in_channel'][0], self.cfg['width_coefficient']))

        self.img_attn = MultiAttnFusion(round_filters(self.cfg['in_channel'][0], self.cfg['width_coefficient']))
        ...
        self.qus_linear = nn.Sequential(nn.Linear(round_filters(self.cfg['in_channel'][0], self.cfg['width_coefficient']), head_conv_out_channels),
...
# 6144367 -> 6301723
def mix_hid_efficientv2_b0(**kwargs):
    return EfficientNetV2("b0", qus_embedding_dim=300, ans_size=kwargs["ans_size"], glove_path=kwargs["glove_path"],
...
# 7145715 -> 7303071
def mix_hid_efficientv2_b1(**kwargs):
    return EfficientNetV2("b1", qus_embedding_dim=300, ans_size=kwargs["ans_size"], glove_path=kwargs["glove_path"],
                          word_size=kwargs["word_size"], select_mix_flag=kwargs["select_mix_flag"],
                          mix_probability=kwargs["mix_probability"], mix_alpha_1=kwargs["mix_alpha_1"],
                          mix_alpha_2=kwargs["mix_alpha_2"])
...
# 9001293 -> 9163129
def mix_hid_efficientv2_b2(**kwargs):
    return EfficientNetV2("b2", qus_embedding_dim=300, ans_size=kwargs["ans_size"], glove_path=kwargs["glove_path"],
                          word_size=kwargs["word_size"], select_mix_flag=kwargs["select_mix_flag"],
                          mix_probability=kwargs["mix_probability"], mix_alpha_1=kwargs["mix_alpha_1"],
                          mix_alpha_2=kwargs["mix_alpha_2"])
...
# 13164157 -> 13351545
def mix_hid_efficientv2_b3(**kwargs):
    return EfficientNetV2("b3", qus_embedding_dim=300, ans_size=kwargs["ans_size"], glove_path=kwargs["glove_path"],
                          word_size=kwargs["word_size"], select_mix_flag=kwargs["select_mix_flag"],
                          mix_probability=kwargs["mix_probability"], mix_alpha_1=kwargs["mix_alpha_1"],
                          mix_alpha_2=kwargs["mix_alpha_2"])
